...
def main():
    # This looks like it shouldn't be needed. But it is, even if the value isn't important. More in this GH issue:
    ...
    # Okay, so if you don't do this locally you will get an index error when this runs:
    # https://github.com/langchain-ai/langchain/compare/master...psaegert:langchain:master hopefully this or
    # something similar will appear in a PR on the library repo soon.
    splits_for_store = text_splitter.split_documents(gdocs)

    # Initialize the vector store
    print("Initializing vector store...")
    vs = vector_store.VectorStore()
    vs.create_store(
        splits_for_store, OllamaEmbeddings(base_url=base_url, model="llama2")
    )
